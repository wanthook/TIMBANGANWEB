        ...
        $(document).ready(function(e)
        {
            ...
            dataTable = $('#tableId').DataTable({
                ...
                [
                    ...
                    { data    : "timbang_in", name: "timbang_in" },
                    { data    : "timbang_out", name: "timbang_out" },
            ...
            $('#cmbBarang').select2({
                ...
                ajax: 
                {
                    url: "{{ route('jenisbarang.selectdashboard') }}",
                    dataType: 'json',
                    type: 'post',                
    ...
    <div class="row">
        <div class="col-lg-12"> 
            <h4 class="page-header">
                ...
                </span>&nbsp;&nbsp;Monitoring Timbangan Indah Jaya
            </h4>
        </div>       
    </div>
    <div class="row">
