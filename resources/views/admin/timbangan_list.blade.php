                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="pull-left form-inline">
                                ...
                                {!! Form::hidden('cmbBarang',null,[ 'id' => 'cmbBarang', 'style' => 'width:150px;']) !!} 
                            ...
                            <div class="pull-right">
                                <a href="{{route('timbangan.upload')}}" class="btn btn-success btn-sm"><i class="fa fa-upload  "></i></a>
                                <a href="{{route('timbangan.add')}}" class="btn btn-success btn-sm"><i class="fa fa-plus-square "></i></a>
                            </div>
                        </div>
