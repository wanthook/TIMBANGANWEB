...
<div class="headtitle">    
    <div class="btn-group">
        ...
        <ul class="dropdown-menu">
            <li>
                <a href="{{ route('departemen.tambah') }}"><i class="iconfa-plus-sign"></i>&nbsp;Tambah Departemen</a>
            </li>
        </ul>
    </div>
    <h4 class="widgettitle">Tabel List Departemen</h4>
